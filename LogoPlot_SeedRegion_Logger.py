...
@author: Tigist shewafera @ Addis Ababa university 
'''
'''project name GCcalc_project
 
    generate seed sequence from miRNA ( mature.fa) for all species code (human,mouse, and rat)  
    generate logoplot by adding logger method for all species code (human, mouse, and rat)'''
...
def main(argv=None):
    ...
    seedBegin = 2
    seedEnd = 8
    filename=  r"C:\Users\dbu\AP\day8T\GCcalc-project\mature.fa"
